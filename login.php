...
<img src='logoMMB.png' height='150' width='165' align='center'>
</div>
...
if (isset($_POST['submitee'])){
  ...
  $query = "SELECT * FROM user WHERE USERNAME ='$gebruiker'AND PASSWORD='$wachtwoord ' "; 
...
<form method="POST">
  ...
  <input  type="password" name="wachtwoord" class="form-control" placeholder="wachtwoord" required> <br><br>
  <input  type="password" name="wachtwoord1" class="form-control" placeholder="Wachtwoord opnieuw" required> <br><br>
